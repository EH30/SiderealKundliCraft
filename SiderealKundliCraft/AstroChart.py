        ...
        for house in range(len(houses)):
            for planet in planets:
                ...
                if planets[planet]["sign_num"] == houses[house].sign_num:
                    ...
                    houses[house].planets[planet]["degree"] = self.degree_minute_second_st(houses[house].planets[planet]["signlon"], houses[house].planets[planet]["minute"], houses[house].planets[planet]["second"])
